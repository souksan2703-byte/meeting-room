...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'RoomReserve'); ?></title>
...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex flex-col items-center justify-center px-4">
    ...
    <p class="text-xs text-gray-400 mt-8">&copy; <?php echo e(date('Y')); ?> RoomReserve. All rights reserved.</p>

</body>
</html><?php /**PATH C:\laragon\www\meeting-room\resources\views/layouts/guest.blade.php ENDPATH**/ ?>