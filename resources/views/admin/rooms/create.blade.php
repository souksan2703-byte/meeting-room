...
<div class="max-w-xl mx-auto">
    ...
    <p class="text-gray-500 mb-6">กรอกรายละเอียดห้องประชุมใหม่</p>
    ...
    <form method="POST" action="{{ route('admin.rooms.store') }}" class="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div>
            ...
            <input type="text" name="location" value="{{ old('location') }}" placeholder="e.g., HQ Campus, Building C, Floor 4"
