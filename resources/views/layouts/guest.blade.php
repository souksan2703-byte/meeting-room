...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex flex-col items-center justify-center px-4" style="font-family: 'Google Sans', 'Phetsarath', sans-serif;">
